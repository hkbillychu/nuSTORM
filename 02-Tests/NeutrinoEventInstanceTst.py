...
n, bins, patches = plt.hist(PrdStrghtcosnumu, bins=50, color='y', range=(-1,1))
...
n, bins, patches = plt.hist(Arc1cosnumu, bins=50, color='y', range=(-1,1))
#print(Arc1cosnumu)
...
n, bins, patches = plt.hist(RetStrghtcosnumu, bins=50, color='y', range=(-1,1))
...
n, bins, patches = plt.hist(Arc2cosnumu, bins=50, color='y', range=(-1,1))
#print(Arc2cosnumu)
