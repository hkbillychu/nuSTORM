...
# -*- coding: utf-8 -*-
"""
Test script for "PionDecay" class -- for truncated decays
=================================
...
##! Start:
print("========  PionDecayTruncated: tests start  ========")

pc = piCnst.PionConst()

##! Create instance, test built-in methods:
PionDecayTruncatedTest = 1
print()
print("PionDecayTruncatedTest:", PionDecayTruncatedTest, " Create pion decay, print quantities.")
...
Tmax = 2.*pc.lifetime()
print("    ----> Tmax =", Tmax, "ns")
Dcy=pd.PionDecay(Tmax=Tmax)
print("    __str__:", Dcy)
print("    --repr__", repr(Dcy))
del Dcy

##! Create instance, test dynamic methods:
PionDecayTruncatedTest = 2
print()
print("PionDecayTruncatedTest:", PionDecayTruncatedTest, " Create Pion decay, print quantities.")
Dcy=pd.PionDecay(Tmax=Tmax)
...
DifE = SumE - pc.mass()
print("    Sum energy:", SumE, "; difference to pion mass:", DifE)
del Dcy

##! Soak test, generate many decays:
PionDecayTruncatedTest = 3
print()
print("PionDecayTruncatedTest:", PionDecayTruncatedTest, " Create many decays.")
Dcy = []
for i in range(100000):
    Dcy.append(pd.PionDecay(Tmax=Tmax))
for i in range(5):
    print(Dcy[i])

##! Plot result of soak test:
PionDecayTruncatedTest = 4
print()
print("PionDecayTruncatedTest:", PionDecayTruncatedTest, " plots from soak test.")
